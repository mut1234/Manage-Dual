...
namespace manage_dual.NewFolder
{
    public class ApplicationDbContext : DbContext
    {
        ...
        modelBuilder.Entity<client>().HasData(
            new client { clientId = 1, Name = "Ahmad", PhoneNumber = "079649321763", Email = "Ahmad3323@gmail.com", Address = "St 124", City = "Amman", PostalCode = "342667" },
            ...
            //Fixed 1 to many bettween client and item, client have many item and each item for 1 client.
            modelBuilder.Entity<client>()
                 .HasMany(e => e.Item)
                 .WithOne(e => e.client)
                 .HasForeignKey(e => e.Client_Item_Id);
            ...
            modelBuilder.Entity<client>()
                .HasMany(e => e.Payment)
                .WithOne(e => e.client)
                .HasForeignKey(e => e.Payment_Client_id);
